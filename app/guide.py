...
SAMPLE_PROBLEMS = [
    ...
    },
    {
        "id": "s1",
        "title": "立体·正方体表面积",
        "text": "一个正方体的棱长为 6cm，求它的表面积。",
        "tags": ["立体几何", "正方体", "表面积"],
    },
    {
        "id": "s2",
        "title": "立体·长方体体积",
        "text": "一个长方体的长、宽、高分别是 5cm、3cm、4cm，求它的体积和表面积。",
        "tags": ["立体几何", "长方体", "体积"],
    },
    {
        "id": "s3",
        "title": "立体·圆柱侧面积",
        "text": "一个圆柱的底面半径是 3cm，高是 8cm，求它的侧面积和体积。（π 取 3.14）",
        "tags": ["立体几何", "圆柱"],
    },
    {
        "id": "s4",
        "title": "立体·圆锥体积",
        "text": "一个圆锥的底面半径为 4cm，高为 9cm，求它的体积。（π 取 3.14）",
        "tags": ["立体几何", "圆锥"],
    },
]
